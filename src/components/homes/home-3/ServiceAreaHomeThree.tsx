...
const service_content: DataType = {
  ...
  btn_text: <>Call us to get more details on how we work <span>Call Now</span></>,
  service_data: [
    {
      id: 1,
      icon: <StrategyIcno />,
    ...
    },
    {
      ...
      sm_des: <>We meet with you on the regular to make sure the product stays on target and we take full ownership of everything we build.</>,
      tag_1: "Ownership",
      tag_2: "Communication",
    },
    {
      ...
      sm_des: <>We are capable of bringing your ideas to life. Whether it is a mobile app or backend API.</>,
      tag_1: "High Quality Code",
      tag_2: "Full Product Support",
    },
  ]
}
