...
import Logo1 from "@/assets/img/logo/logo-2.png"
          ...
          <div className="tp-offcanvas-left">
            <div className="tp-offcanvas-left-wrap d-flex justify-content-between align-items-center">
              ...
              <div className="tpoffcanvas__logo">
                {style_bg ?
                  <Image className="logo-white" style={{ height: '75px' }} src={logo_white} alt="image" />
                  :
                  <>
                    <Image className="logo-white" style={{ height: '75px', width: "75px" }} src={Logo1} alt="image" />
                    <Image className="logo-black" style={{ height: '75px', width: "75px" }} src={Logo2}alt="image" />
                  </>
          ...
          <div className="tp-offcanvas-right d-none d-md-block">
            ...
            <div className="tp-offcanvas-right-inner d-flex flex-column justify-content-between h-100">
              ...
              <div className="tpoffcanvas__social-link">
                <ul>
                  <li><a href="https://www.linkedin.com/company/elco-dev" target="_blank">Linkedin</a></li>
                </ul>
              </div>
            </div>
          </div>
