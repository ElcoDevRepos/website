...
const ContactForm = (params: any) => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    const response = await fetch("/api/send", {
      ...
      body: JSON.stringify({...data, categories: params.selectedCategories, budget_category: activeCategory ? budget_categorys[activeCategory].title : ""}),
    })
