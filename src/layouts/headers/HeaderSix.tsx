            ...
            <div className="row align-items-center">
              <div className="col-xl-6 col-lg-6 col-md-6 col-6">
                <div className="tp-header-3__logo">
                  <Link className="logo-white" style={{ height: '75px'}}href="/"><Image src={logo} alt="image-here" /></Link>
                  <Link className="logo-black"style={{ height: '75px'}} href="/"><Image src={logo} alt="image-here" /></Link>
                </div>
              </div>
