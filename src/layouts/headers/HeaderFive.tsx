            ...
            <div className="row align-items-center">
              <div className="col-xl-6 col-lg-6 col-md-6 col-6">
                <div className="tp-header-3__logo">
                  <Link className="logo-white" style={{ height: '75px'}}href="/"><Image src={logo_white} alt="image-here" /></Link>
                  <Link className="logo-black" style={{ height: '75px'}}href="/"><Image src={logo_red} alt="image-here" /></Link>
                </div>
              </div>
        ...
        <div className="tp-header-3__area tp-header-transparent tp-header-3__ptlr tp-int-menu tp-header-4-sticky-bg tp-header-sticky-cloned">
          <div className="container-fluid">
            <div className="row align-items-center">
              <div className="col-xl-6 col-lg-6 col-md-6 col-6">
                <div className="tp-header-3__logo">
                  <Link className="logo-white"  href="/"><Image src={logo_white} alt="image-here" style={{ height: '75px'}}/></Link>
                  <Link className="logo-black" href="/"><Image src={logo_red} alt="image-here" style={{ height: '75px'}}/></Link>
                </div>
              </div>
              <div className="col-xl-6 d-none">
                <div className="tp-header-4__menu text-center">
