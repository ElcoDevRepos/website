            ...
            <div className="row align-items-center">
              <div className="col-xl-6 col-lg-6 col-md-6 col-6">
                <div className="tp-header-3__logo">
                  <Link className="logo-white" href="/"><Image src={lightLogo} style={{height: "75px", width: "75px"}} alt="image-here" /></Link>
                  <Link className="logo-black" href="/"><Image src={darkLogo} style={{height: "75px", width: "75px"}}  alt="image-here" /></Link>
                </div>
              </div>
