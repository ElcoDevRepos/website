            ...
            <div className="row align-items-center">
              <div className="col-xl-2 col-lg-6 col-md-6 col-6">
                <div className="tp-header-3__logo">
                  {style ?
                    <>
                      <Link className="logo-white" href="/"><Image src={logo} alt="logo" style={{ height: '75px', width: '75px'}}/></Link>
                      <Link className="logo-black" href="/"><Image src={logo} alt="logo" style={{ height: '75px', width: '75px'}} /></Link>
                    </>
                    :
                    <>

                      <Link className="logo-white" href="/"><Image src={lightLogo} alt="image-here" style={{ height: '75px', width: '75px'}}/></Link>
                      <Link className="logo-black" href="/"><Image src={darkLogo} alt="image-here" style={{ height: '75px', width: '75px'}}/></Link>
                    </>
